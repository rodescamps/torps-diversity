...
def build_prob_matrix(guards_probabilities, exits_probabilities, probabilities_reduction, denasa, e_select,
    ...
    if aggregated_probability != 0.0:
        ...
        for guard_address in aggregated_guards_probabilities:
            aggregated_guards_probabilities[guard_address] = aggregated_guards_probabilities[
                                                                 guard_address] + probability_to_distribute
    ...
    if aggregated_probability != 0.0:
        ...
        for exit_address in aggregated_exits_probabilities:
            aggregated_exits_probabilities[exit_address] = aggregated_exits_probabilities[
                                                               exit_address] + probability_to_distribute
